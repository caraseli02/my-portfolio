<template>
  <header class="fixed top-0 left-0 right-0 z-50 bg-cream-100/95 dark:bg-charcoal/95 backdrop-blur-sm border-b border-cobalt-500/10 dark:border-charcoal-200/30">
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
      <nav class="flex items-center justify-between h-20">
        ...
        >
          <svg v-if="theme === 'dark'" viewBox="0 0 24 24" class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
          ...
          <svg v-else viewBox="0 0 24 24" class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
