      ...
      <div class="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div class="space-y-6">
          <div
            ...
            :key="index"
            class="group relative bg-white rounded-2xl border border-gray-200 p-8 hover:border-vue-500 transition-all duration-300 card-hover"
          >
      ...
      <div class="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div
            ...
            :key="value.title"
            class="p-6 rounded-2xl border border-gray-200 hover:border-vue-500 transition-all duration-300 card-hover"
          >
    ...
    <section class="py-20 bg-gray-50">
      <div class="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          <div
            v-for="badge in githubBadges"
            :key="badge.name"
            class="bg-white rounded-xl border border-gray-200 p-4 text-center hover:border-vue-500 transition-colors"
          >
      ...
      timeline: [
        {
          ...
          description:
            "Building modern web applications for clients using Vue 3, Nuxt 3, and TypeScript. Developing full-stack solutions with Python/FastAPI backends. Contributing to open-source projects and mentoring junior developers.",
        ...
        },
        {
          ...
          description:
            "Developed and maintained multiple client-facing web applications using Vue.js and Nuxt. Implemented responsive designs, integrated third-party APIs, and optimized application performance. Worked in Agile teams with CI/CD workflows.",
        ...
        },
        {
          ...
          description:
            "Started professional career building web applications with Vue.js. Gained experience with component-based architecture, state management with Vuex, and modern frontend tooling. Contributed to internal tools and client projects.",
      ...
      values: [
        {
          ...
          description:
            "I prioritize writing readable, maintainable code following Vue.js best practices and the Composition API patterns.",
        },
        {
          icon: "\u{1F680}",
          iconBg: "bg-blue-100",
          ...
          description:
            "Every application I build is optimized for speed. I leverage SSR, code splitting, and modern build tools like Vite.",
        },
        {
          icon: "\u{1F91D}",
          ...
          title: "Open Source",
          description:
            "I believe in giving back to the community. With 58+ public repos, I actively contribute to and learn from open source.",
        },
        {
          icon: "\u{1F4D6}",
          iconBg: "bg-amber-100",
          ...
          description:
            "Technology evolves rapidly. I stay current by exploring new tools, frameworks, and patterns in the Vue.js ecosystem.",
        },
      ],
      githubBadges: [
