          ...
          >
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-0">
              ...
              <div class="lg:col-span-3 p-8 lg:p-10">
                ...
                <!-- Metaphor tagline -->
                <p v-if="project.caseStudy" class="text-cobalt-500 text-sm font-medium italic mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                  <span
                    ...
                    :key="tech"
                    class="tech-badge bg-white text-cobalt-700 border border-cobalt-500/20"
                  >
                    {{ tech }}
                  </span>
                </div>
              ...
              <!-- Links panel -->
              <div class="lg:col-span-2 bg-cobalt-700 p-8 lg:p-10 flex flex-col justify-center">
            ...
            <div class="p-6">
              ...
              <div class="flex flex-wrap gap-1.5">
                <span
                  v-for="tech in project.tech"
                  :key="tech"
                  class="px-2.5 py-1 bg-cream-200 text-cobalt-700 rounded-md text-xs font-medium"
                >
                  {{ tech }}
                </span>
              </div>
      ...
      <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center gap-2 px-7 py-3.5 bg-white text-cobalt-700 rounded-xl hover:bg-cream-50 transition-all duration-200 font-semibold ripple-container"
            data-cursor="button"
          >
