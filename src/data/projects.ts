...
export const featuredProjects: FeaturedProject[] = [
  {
    ...
    description: 'A luxury real estate browser with interactive map, multi-currency pricing, and advanced filtering. Built for the international property market where homes are listed in EUR, GBP, CHF, and more.',
    highlights: [
      ...
      timeline: [
        {
          ...
          narrative: 'Luxury listings lived in different databases with different currencies and no map integration. Agents cross-referenced spreadsheets while clients browsed separate sites.',
        ...
        },
        {
          ...
          narrative: 'A villa at €4.5M and a penthouse at £3.2M couldn\'t be compared in the same filter range. I needed a service to parse any currency format and normalize to a single baseline.',
        ...
        },
        {
          ...
          narrative: 'React 18 + TypeScript for type safety. shadcn/ui for accessible components. Every service — filtering, pricing, XSS protection — is a pure function with zero side effects.',
        ...
        },
        {
          ...
          narrative: 'Leaflet marker icons broke with Vite\'s module system. Modals fought for z-index dominance. Property images randomly 404\'d, leaving blank cards.',
        },
        {
          id: 'breakthrough',
          label: 'Breakthrough',
          ...
          narrative: 'Moved modals to React portals at document.body — clean z-index isolation. Built an image resilience system that auto-advances to the next valid image on failure.',
        ...
        },
        {
          ...
          narrative: '24 luxury properties across 8 currencies with seamless filtering, interactive map, and draft-state filter modal. Four rounds of UI review locked in accessibility.',
        },
      ],
      outcomes: [
  ...
  },
  {
    ...
    title: 'ECAS',
    category: 'Full-Stack Application',
    description: 'A production-grade e-commerce platform with tiered pricing engine, Stripe payments, Firebase auth, and a full admin dashboard. Complete shopping flow from browsing to order tracking.',
    highlights: [
      ...
      timeline: [
        {
          ...
          narrative: 'Real commerce needs tiered pricing, per-user discounts, customer credit with freeze/unfreeze, and an admin dashboard that actually manages the business.',
        ...
        },
        {
          ...
          narrative: 'Pricing was three-dimensional: entry price ranges, quantity brackets that change unit cost, and gross/net margins. A flat discount percentage doesn\'t capture this.',
          detail: 'Designed PriceSmartLinkingInterface connecting ranges, tiers, and margins per product.',
        },
        {
          id: 'approach',
          label: 'The Approach',
          ...
          narrative: '17 API services extend a generic HttpFactory with typed call<T>(). Firebase bridges to backend via Bearer token. Stripe handles multi-payment flows.',
        ...
        },
        {
          ...
          narrative: 'Stripe returns 5 different payment states. Each needed a different UI response. Mock mode needed 4 validation layers to prevent accidental production activation.',
        },
        {
          id: 'breakthrough',
          label: 'Breakthrough',
          ...
          narrative: 'Built an error sanitizer that masks passwords, tokens, API keys, and credit card numbers before anything reaches the console or UI. A security boundary, not debugging help.',
        ...
        },
        {
          ...
          narrative: 'Complete shopping flow: browse → cart → checkout → order tracking. Admin dashboard with smart pricing, customer credit (freeze/unfreeze), and full audit trail.',
        },
      ],
      outcomes: [
  ...
  },
  {
    ...
    description: 'A hotel booking upsell component library with strict UI/business logic separation. Components receive 30+ pre-computed fields — zero logic in the render layer. Documented with Storybook 10 and tested with Chromatic.',
    highlights: [
      ...
      timeline: [
        {
          ...
          narrative: 'Four pricing models (per stay, per person, per night, all-inclusive) with different date selection and validation rules. Every pricing change meant rewriting UI code.',
        ...
        },
        {
          ...
          narrative: 'If OfferCard receives a pre-computed OfferCardData with 30+ fields, the component literally cannot do business logic — even if someone tries. The type system enforces separation.',
          detail: 'OfferCardData: formatted prices, validation results, state flags — zero logic needed.',
        },
        {
          id: 'approach',
          label: 'The Approach',
          ...
          narrative: 'UI primitives → domain composites → Storybook stories. TypeScript discriminated unions enforce that each pricing variant carries only its relevant fields.',
        ...
        },
        {
          ...
          narrative: 'The sticky pricing sidebar needed dynamic height based on scroll and viewport. Naive approaches caused jank — recalculating on every scroll event tanks frame rate.',
        },
        {
          id: 'breakthrough',
          label: 'Breakthrough',
          ...
          narrative: 'ResizeObserver + throttled scroll (100ms) + debounced scroll-end (200ms) + 10px threshold + RAF calculations. On mobile, the hook disables entirely — no wasted cycles.',
        ...
        },
        {
          ...
          narrative: 'Pricing changes touch calculation utilities, not components. Adding a new offer type means extending a union — the compiler tells you every place that needs updating.',
        },
      ],
      outcomes: [
